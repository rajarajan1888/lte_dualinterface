...
public:
  LteHelper (void);
  LteHelper (uint32_t nUEs, uint32_t nCells);
  ...
  NetDeviceContainer InstallEnbDevice (NodeContainer c , uint16_t dlearfcn, uint16_t ulearfcn);

  NetDeviceContainer InstallEnbDevice (NodeContainer c , uint8_t noOfAntennae);
  ...
  NetDeviceContainer InstallUeDevices (NodeContainer c , uint16_t noOfDevs);
  ...
  /**RAJARAJAN**/
  void AddDeviceToChannel (Ptr<NetDevice> ueDevice);

  void AddeNBToChannel (Ptr<ListPositionAllocator> eNBpositionAllocMacro , uint16_t nUEs);

  /**---RAJARAJAN---**/

  void Attach (Ptr<NetDevice> ueDevice, Ptr<NetDevice> enbDevice);

  void AttachCA (Ptr<NetDevice> ueDevice, Ptr<NetDevice> enbDevice);
  ...
  void ActivateDedicatedEpsBearerCA (NetDeviceContainer ueDevices, EpsBearer bearer, Ptr<EpcTft> tft);
  ...
  void SetCellBiasValue (uint8_t);

  std::vector<double> receiveRsrp (uint64_t imsi);

  std::vector<std::vector<double> > getRsrpVector ();
  std::vector<std::vector<double> > getRsrpAllVector ();
  std::vector<std::vector<double> > getSinrVector ();
  std::vector<std::vector<double> > getTbsVector ();

  static void passRsrpStats(std::vector<std::vector<double> > rsrpVector );
  static void passRsrpStats(std::vector<std::vector<double> > rsrpVector , std::vector<std::vector<double> > sinrVector);
  static void passTbsStats (std::vector<std::vector<double> > tbs);
...
private:
  ...
  Ptr<NetDevice> InstallSingleEnbDevice (Ptr<Node> n , uint16_t dlearfcn , uint16_t ulearfcn);
  Ptr<NetDevice> InstallSingleEnbDeviceWithMultipleAntennae (Ptr<Node> n , uint8_t noOfAntennae);
  Ptr<NetDevice> InstallSingleUeDevice (Ptr<Node> n);

  std::vector<Ptr<NetDevice> > InstallMultipleUeDevice (Ptr<Node> n , uint16_t noOfDevs);
  ...
  static std::vector<std::vector<double> > rsrpVtr;
  static std::vector<std::vector<double> > rsrpAllVtr;
  static std::vector<std::vector<double> > sinrVtr;
  static std::vector<std::vector<double> > tbsVtr;
