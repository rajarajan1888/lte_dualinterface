...
public:
  ...
  virtual void AddeNB (Ptr<ListPositionAllocator> eNBpositionAllocMacro , uint16_t nUEs);

  virtual void StartTx (Ptr<SpectrumSignalParameters> params);

  virtual void SetDirection (uint8_t direction);
  virtual void AddType (char type);
...
private:
  ...
  TracedCallback<uint16_t, uint64_t, double> m_reportAllCellRsrp;
