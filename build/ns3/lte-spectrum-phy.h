...
public:
  ...
  uint8_t GetNoOfAntennae ();
  std::vector<Ptr<AntennaModel> > GetRxAntennaVector ();
  void SetAntennaVector (std::vector<Ptr<AntennaModel> > avtr);
  /**
 ...
 private:
  ...
  uint8_t m_noOfAntennae;
  Ptr<MobilityModel> m_mobility;
  Ptr<AntennaModel> m_antenna;
  std::vector<Ptr<AntennaModel> > m_sectoredAntennaVtr;
