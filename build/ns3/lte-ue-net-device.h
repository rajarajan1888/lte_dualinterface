...
public:
  ...
  LteUeNetDevice (Ptr<Node> node, Ptr<LteUePhy> phy, Ptr<LteUeMac> mac, Ptr<LteUeRrc> rrc, Ptr<EpcUeNas> nas, uint8_t maxCCs);
  ...
  void ActivateDedicatedEpsBearerCA (EpsBearer bearer, Ptr<EpcTft> tft);
