...
*/
	...
	eNBpositionAllocSmall->Add(Vector(250,	250, 10 ));
		eNBpositionAllocSmall->Add(Vector(250,	750, 10 ));
		eNBpositionAllocSmall->Add(Vector(750,	250, 10 ));
		eNBpositionAllocSmall->Add(Vector(750,	750, 10 ));
		eNBpositionAllocSmall->Add(Vector(500,	1000, 10 ));
		eNBpositionAllocSmall->Add(Vector(500,	0, 10 ));
		eNBpositionAllocSmall->Add(Vector(1000,	500, 10 ));
		eNBpositionAllocSmall->Add(Vector(0,	500, 10 ));
	...
	eNBpositionAllocSmall->Add(Vector(750,	67, 10 ));
	eNBpositionAllocSmall->Add(Vector(250,	67, 10 ));
	eNBpositionAllocSmall->Add(Vector(1000,	716.5, 10 ));
	eNBpositionAllocSmall->Add(Vector(750,	933, 10 ));
	eNBpositionAllocSmall->Add(Vector(500,	250, 10 ));
	eNBpositionAllocSmall->Add(Vector(250,	933, 10 ));
	eNBpositionAllocSmall->Add(Vector(0,	716.5, 10 ));
	eNBpositionAllocSmall->Add(Vector(0,	283.5, 10 ));
	eNBpositionAllocSmall->Add(Vector(1000,	283.5, 10 ));
	eNBpositionAllocSmall->Add(Vector(500,	750, 10 ));
*/
...
static void GetRsrpStats (Ptr<LteHelper> lteHelper , Ipv4InterfaceContainer ueIpIface , NetDeviceContainer ueDevices , NetDeviceContainer enbDevs)
{
	...
	std::filebuf fb;
	fb.open("//home//rajarajan//Documents//lena//NEC//files//getrsrpvals_stadiumnec_8.txt",std::ios::out);
	std::ostream osrsrp(&fb);

	std::filebuf fb1;
	fb1.open("//home//rajarajan//Documents//lena//NEC//files//getassociation_stadiumnec_8.txt",std::ios::out);
