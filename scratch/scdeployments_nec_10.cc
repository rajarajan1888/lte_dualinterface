...
*/
	...
	eNBpositionAllocSmall->Add(Vector(1000,	567,	10));
	eNBpositionAllocSmall->Add(Vector(1000,	1433,	10));
	eNBpositionAllocSmall->Add(Vector(750,	1216.5,	10));
	eNBpositionAllocSmall->Add(Vector(1250,	1216.5,	10));
	eNBpositionAllocSmall->Add(Vector(750,	783.5,	10));
	eNBpositionAllocSmall->Add(Vector(1250,	783.5,	10));
...
static void GetRsrpStats (Ptr<LteHelper> lteHelper , Ipv4InterfaceContainer ueIpIface , NetDeviceContainer ueDevices , NetDeviceContainer enbDevs)
{
	...
	std::filebuf fb;
	fb.open("//home//rajarajan//Documents//lena//NEC//files//getrsrpvals_smallcell_nec_10.txt",std::ios::out);
	std::ostream osrsrp(&fb);

	std::filebuf fb1;
	fb1.open("//home//rajarajan//Documents//lena//NEC//files//getassociation_smallcell_nec_10.txt",std::ios::out);
