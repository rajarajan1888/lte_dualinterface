...
public:
  ...
  void SetSector (uint8_t sectorId);
...
private:
  ...
  virtual void DoSetNodeId (uint16_t nodeId);
  virtual uint16_t DoGetNodeId ();

  virtual void DoSetFreq (double cbFreq);
  virtual double DoGetFreq ();
