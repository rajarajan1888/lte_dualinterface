...
void
BuildingsMobilityModel::DoSetFreq (double cbFreq)
{
	m_cbFreq = cbFreq;
}

double
BuildingsMobilityModel::DoGetFreq ()
{
	return m_cbFreq;
}

void
BuildingsMobilityModel::DoSetNodeId (uint16_t nodeId)
{
	m_nodeId = nodeId;
}

uint16_t
BuildingsMobilityModel::DoGetNodeId ()
{
	return m_nodeId;
}
