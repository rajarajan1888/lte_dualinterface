...
public:
  ...
  void SetCellBias (uint8_t);

  uint8_t GetCellBias (void) const;
  /**
  ...
  void StartCA (uint8_t noOfCCs);

  void UpdateConfigCA (uint8_t noOfCCs);

  // YANNIS

  Ptr<FfMacScheduler> GetScheduler(void) const;
