...
void
FfMacScheduler::SetBlankIndicator ( uint32_t absFlag )
{
	blankIndicator = absFlag;
	(absFlag == 1 ) ? std::cout<<"Blanking Indicator : ABS"<<std::endl :std::cout<<"Blanking Indicator : Non-ABS"<<std::endl;
}

uint32_t
FfMacScheduler::GetBlankIndicator ()
{
