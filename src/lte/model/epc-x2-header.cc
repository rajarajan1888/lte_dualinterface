...
void
EpcX2HandoverRequestHeader::SetOldRnti (uint16_t m_oldEnbUeX2apId)
{
	this->m_oldEnbUeX2apId=m_oldEnbUeX2apId;
}

uint16_t
EpcX2HandoverRequestHeader::GetOldRnti () const
{
	return this->m_oldEnbUeX2apId;
}
...
void
EpcX2HandoverRequestAckHeader::SetOldRnti (uint16_t m_oldEnbUeX2apId)
{
	this->m_oldEnbUeX2apId=m_oldEnbUeX2apId;
}

uint16_t
EpcX2HandoverRequestAckHeader::GetOldRnti () const
{
	return this->m_oldEnbUeX2apId;
}
