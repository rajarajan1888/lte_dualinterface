...
LteRlcSm::DoNotifyTxOpportunity (uint32_t bytes, uint8_t layer, uint8_t harqId)
{
  ...
  myFile11.open("//home//rajarajan//Documents//att_workspace//ltea//TxOpportunity.txt");
  myFile11<<"Problem here? \n";
  myFile11.close();
...
LteRlcSm::ReportBufferStatus ()
{
  ...
  std::ofstream myFileRlc;
    myFileRlc.open("LTE_RLC_ONLY");
    myFileRlc<<"LTE RLC ONLY\n";
    myFileRlc.close();
}
