...
/*Ptr<PacketBurst>
LteSpectrumSignalParameters::GetBurst ()
{
	NS_LOG_FUNCTION (this);
	return packetBurst;
}
...
/*Ptr<PacketBurst>
LteSpectrumSignalParametersDataFrame::GetBurst ()
{
	NS_LOG_FUNCTION (this);
	return packetBurst;
}*/
...
/*Ptr<PacketBurst>
LteSpectrumSignalParametersDlCtrlFrame::GetBurst ()
{
	NS_LOG_FUNCTION (this);
	return NULL;
}*/
...
/*Ptr<PacketBurst>
LteSpectrumSignalParametersUlSrsFrame::GetBurst ()
{
	NS_LOG_FUNCTION (this);
	return NULL;
}*/
