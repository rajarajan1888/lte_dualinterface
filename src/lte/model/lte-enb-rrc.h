...
public:
  ...
  void ConfigureCellCA (uint8_t ulBandwidth,
                        uint8_t dlBandwidth,
                        uint16_t ulEarfcn,
                        uint16_t dlEarfcn,
                        uint16_t cellId,
  ...
  uint16_t DoRecvConnectionRequestCA (uint64_t imsi);
  ...
  void RemoveUe (Ptr<LteUeNetDevice> ueDev);
  ...
  //RAJARAJAN
  void SendHandoverRequest ( uint64_t imsi, uint16_t cellId);
  //--RAJARAJAN--
