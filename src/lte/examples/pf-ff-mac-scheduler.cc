...
{
  NS_LOG_FUNCTION (this);
  static std::ofstream cqifile;
  static int counter = 0;
  if(counter==0)
	  cqifile.open("//home//rajarajan//Documents//att_workspace//ltea//cqivals.txt");
  counter++;
      ...
      if ( params.m_cqiList.at (i).m_cqiType == CqiListElement_s::P10 )
        {
          ...
          if (it == m_p10CqiRxed.end ())
            {
        	  cqifile<<"P10 reaches end, Time : "<<Simulator::Now().GetMilliSeconds()<<" RNTI : "<<rnti<<" CQI value : "<<params.m_cqiList.at (i).m_wbCqi.at(0)<<"\n";
            ...
            {
        	  cqifile<<"P10 does not reach end, Time : "<<Simulator::Now().GetMilliSeconds()<<" RNTI : "<<rnti<<" CQI value : "<<params.m_cqiList.at (i).m_wbCqi.at(0)<<"\n";
      ...
      else if ( params.m_cqiList.at (i).m_cqiType == CqiListElement_s::A30 )
        {
          ...
          if (it == m_a30CqiRxed.end ())
            {
              // create the new entry
        	  cqifile<<"A30 Reaches end, Time : "<<Simulator::Now().GetMilliSeconds()<<" RNTI : "<<rnti<<" CQI value : "<<params.m_cqiList.at (i).m_sbMeasResult<<"\n";
            ...
            {
        	  cqifile<<"A30 does not reach end, Time : "<<Simulator::Now().GetMilliSeconds()<<" RNTI : "<<rnti<<" CQI value : "<<params.m_cqiList.at (i).m_sbMeasResult<<"\n";
              // update the CQI value and refresh correspondent timer
