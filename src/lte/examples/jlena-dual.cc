          ...
          if (enbdev)
            {
              ...
              outFile << "set label \"" << enbdev->GetCellId ()
                      << "\" at "<< pos.x << "," << pos.y << " left font \"Helvetica,10\" textcolor rgb \"white\" front  point pt 2 ps 0.3 lc rgb \"white\" offset 0,0"
                      << std::endl;
            }
        }
    }
  ...
  if (generateRem)
    {
      ...
      //emHelper->SetAttribute ("XRes", UintegerValue (1000));
