...
void
ConstantAccelerationMobilityModel::DoSetFreq (double cbFreq)
{
	m_cbFreq = cbFreq;
}

double
ConstantAccelerationMobilityModel::DoGetFreq ()
{
	return m_cbFreq;
}
...
void
ConstantAccelerationMobilityModel::DoSetNodeId (uint16_t nodeId)
{
	m_nodeId = nodeId;
}

uint16_t
ConstantAccelerationMobilityModel::DoGetNodeId ()
{
	return m_nodeId;
}
