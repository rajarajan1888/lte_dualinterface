...
void
GaussMarkovMobilityModel::DoSetFreq (double cbFreq)
{
	m_cbFreq = cbFreq;
}

double
GaussMarkovMobilityModel::DoGetFreq ()
{
	return m_cbFreq;
}
...
void
GaussMarkovMobilityModel::DoSetNodeId (uint16_t nodeId)
{
	m_nodeId = nodeId;
}

uint16_t
GaussMarkovMobilityModel::DoGetNodeId ()
{
	return m_nodeId;
}
