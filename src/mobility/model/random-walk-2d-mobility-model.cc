...
void
RandomWalk2dMobilityModel::DoSetNodeId (uint16_t nodeId)
{
	m_nodeId = nodeId;
}

uint16_t
RandomWalk2dMobilityModel::DoGetNodeId ()
{
	return m_nodeId;
}

void
RandomWalk2dMobilityModel::DoSetFreq (double cbFreq)
{
	m_cbFreq = cbFreq;
}

double
RandomWalk2dMobilityModel::DoGetFreq ()
{
	return m_cbFreq;
}
