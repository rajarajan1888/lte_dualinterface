...
public:
  ...
  void SetFreq (double cbFreq);
  double GetFreq ();

  void SetNodeId (uint16_t sectorId);
...
private:
  ...
  virtual void DoSetNodeId (uint16_t sectorId) = 0;
  virtual void DoSetFreq (double cbFreq) = 0;

  virtual uint16_t DoGetNodeId () = 0;
  virtual double DoGetFreq () = 0;
  /**
