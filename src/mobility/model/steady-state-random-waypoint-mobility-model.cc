...
void
SteadyStateRandomWaypointMobilityModel::DoSetFreq (double cbFreq)
{
	m_cbFreq = cbFreq;
}

double
SteadyStateRandomWaypointMobilityModel::DoGetFreq ()
{
	return m_cbFreq;
}
...
void
SteadyStateRandomWaypointMobilityModel::DoSetNodeId (uint16_t nodeId)
{
	m_nodeId = nodeId;
}

uint16_t
SteadyStateRandomWaypointMobilityModel::DoGetNodeId ()
{
	return m_nodeId;
}
