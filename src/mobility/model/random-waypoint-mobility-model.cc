...
void
RandomWaypointMobilityModel::DoSetFreq (double cbFreq)
{
	m_cbFreq = cbFreq;
}

double
RandomWaypointMobilityModel::DoGetFreq ()
{
	return m_cbFreq;
}
...
void
RandomWaypointMobilityModel::DoSetNodeId (uint16_t nodeId)
{
	m_nodeId = nodeId;
}

uint16_t
RandomWaypointMobilityModel::DoGetNodeId ()
{
	return m_nodeId;
}
