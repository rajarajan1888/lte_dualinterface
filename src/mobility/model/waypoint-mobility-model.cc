...
void
WaypointMobilityModel::DoSetFreq (double cbFreq)
{
	m_cbFreq = cbFreq;
}

double
WaypointMobilityModel::DoGetFreq ()
{
	return m_cbFreq;
}
...
void
WaypointMobilityModel::DoSetNodeId (uint16_t nodeId)
{
	m_nodeId = nodeId;
}

uint16_t
WaypointMobilityModel::DoGetNodeId ()
{
	return m_nodeId;
}
