...
void
ConstantPositionMobilityModel::DoSetFreq (double cbFreq)
{
	m_cbFreq = cbFreq;
}

double
ConstantPositionMobilityModel::DoGetFreq ()
{
	return m_cbFreq;
}

void
ConstantPositionMobilityModel::DoSetNodeId (uint16_t nodeId)
{
	m_nodeId = nodeId;
}

uint16_t
ConstantPositionMobilityModel::DoGetNodeId ()
{
	 return m_nodeId;
}
