...
void
HierarchicalMobilityModel::DoSetFreq (double cbFreq)
{
	m_cbFreq = cbFreq;
}

double
HierarchicalMobilityModel::DoGetFreq ()
{
	return m_cbFreq;
}

void
HierarchicalMobilityModel::DoSetNodeId (uint16_t nodeId)
{
	m_nodeId = nodeId;
}

uint16_t
HierarchicalMobilityModel::DoGetNodeId ()
{
	return m_nodeId;
}
