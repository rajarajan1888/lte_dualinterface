...
void
ConstantVelocityMobilityModel::DoSetFreq (double cbFreq)
{
	m_cbFreq = cbFreq;
}

double
ConstantVelocityMobilityModel::DoGetFreq ()
{
	return m_cbFreq;
}
...
void
ConstantVelocityMobilityModel::DoSetNodeId (uint16_t nodeId)
{
	m_nodeId = nodeId;
}

uint16_t
ConstantVelocityMobilityModel::DoGetNodeId ()
{
	return m_nodeId;
}
