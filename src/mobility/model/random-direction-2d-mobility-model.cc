...
void
RandomDirection2dMobilityModel::DoSetFreq (double cbFreq)
{
	m_cbFreq = cbFreq;
}

double
RandomDirection2dMobilityModel::DoGetFreq ()
{
	return m_cbFreq;
}

void
RandomDirection2dMobilityModel::DoSetNodeId (uint16_t nodeId)
{
	m_nodeId = nodeId;
}

uint16_t
RandomDirection2dMobilityModel::DoGetNodeId ()
{
	return m_nodeId;
}
