...
{
  m_startTime = start;
//  std::cout<<"Start time = "<<m_startTime.GetMilliSeconds()<<std::endl;
//  sleep(2);
}
void
...
{ // Provide null functionality in case subclass is not interested
	std::ofstream myApp;
	myApp.open("//home//rajarajan//Documents//att_workspace//ltea//app_start.txt");
	myApp<<"Punnagaiye thee mootti poraale\n";
	myApp.close();
}
...
{ // Provide null functionality in case subclass is not interested
	std::ofstream myApp;
	myApp.open("//home//rajarajan//Documents//att_workspace//ltea//app_stop.txt");
	myApp<<"Punnagaiye thee mootti poraale\n";
	myApp.close();
}
