...
void
Node::SetNodeID (uint16_t nodeID)
{
  m_nodeId = nodeID;
}
...
void
Node::AddCellBias (uint8_t cellBias)
{
	m_cellBias = cellBias;
}

uint8_t
Node::getCellBias (void) const
{
	return m_cellBias;
}
                                ...
                                const Address &from, const Address &to, NetDevice::PacketType packetType)
{
  ...
  /*std::cout<<" Promisc Receive From Device"<<std::endl;
  sleep(3);*/
...
{
  NS_LOG_FUNCTION (this);
  /*std::cout<<" Non Promisc Receive From Device"<<std::endl;
    sleep(3);*/
          ...
          if (i->protocol == 0 || 
              i->protocol == protocol)
            {
              if (promiscuous == i->promiscuous)
                {
            	  /*
            	  std::cout<<" IPv4 L3 protocol ADD INTERFACE"<<std::endl;
            	            sleep(3); */
