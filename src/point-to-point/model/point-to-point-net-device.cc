...
PointToPointNetDevice::TransmitStart (Ptr<Packet> p)
{
  ...
  std::cout<<" Current time is "<<Simulator::Now().GetMilliSeconds()<<" Schedule TransmitCompleteEvent in " << txCompleteTime.GetMilliSeconds () << "ms"<<std::endl;
  //sleep(2);
...
{
	std::cout<<"PTP device send "<<std::endl;
  ...
  if (m_txMachineState == READY) 
    {
	  std::cout<<"Tx Machine state is ready"<<std::endl;
	  	//  sleep(2);
      // 
    ...
    {
	  std::cout<<"Current Time is : "<<Simulator::Now().GetMilliSeconds()<<" Tx Machine state is NOT ready"<<std::endl;
	 // sleep(2);
