...
void
MultiModelSpectrumChannel::AddType( char type )
{
	channelType = type;
}

void
MultiModelSpectrumChannel::SetDirection (uint8_t direction)
{
...
void
MultiModelSpectrumChannel::AddeNB (Ptr<ListPositionAllocator> eNBpositionAllocMacro , uint16_t nUEs)
{
